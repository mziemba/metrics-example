...
VM_ARGS="-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=51111 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false"
